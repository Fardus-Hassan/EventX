    ...
    return (
        <div className='max-w-[1440px] w-[98%] mx-auto pb-10 sm:pb-[100px]'>
            <div>
                ...
                <div className="max-w-[1440px] mx-auto mb-10 sm:mb-[100px] flex lg:flex-row-reverse flex-col justify-between items-center gap-20">
                    <div data-aos="fade-down" data-aos-duration="1000" className="relative">
                        <div className='flex justify-between'>
                            <img className='block w-[48.5%] rounded-xl mb-20 object-cover h-[500px]' src="https://images.pexels.com/photos/5428771/pexels-photo-5428771.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load" alt="" />
                            <img className='block w-[48.5%] rounded-xl object-cover h-[600px]' src="https://images.pexels.com/photos/1540406/pexels-photo-1540406.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
                        </div>
                        <div className='max-w-[400px] h-fit p-6 bg-pmColor bg-opacity-80 rounded-xl absolute bottom-[-8%]'>
