...
const Banner = () => {
    ...
    return (
        ...
        <div className='pb-10 sm:pb-[100px] relative'>
            ...
            >
                <SwiperSlide>
                    <img className='lg:min-h-[calc(100vh-88px)] md:min-h-[calc(100vh-85px)] min-h-[calc(100vh-78px)] object-cover block w-full' src="https://images.pexels.com/photos/7709189/pexels-photo-7709189.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=1" alt="" />
